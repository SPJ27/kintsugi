...
export default function Hero() {
    ...
    return (
        <div className="flex  flex-col gap-12 relative min-h-screen justify-center items-center text-center ">
            ...
            <div className={`absolute rotate-2 text-[#90782C] -top-4 w-38 items-center text-left font-medium text-lg ${kalam.className} px-4 py-4 bg-[#FFEF6D] border-[#c8aa1e] border-1 shadow-[3px_4px_10px_rgba(0,0,0,0.1)] left-4`}>
            ...
            <div className={`absolute right-8 rotate-2 text-[#90782C] -top-4 w-68 items-center text-left font-medium text-sm ${kalam.className} px-4 py-4 bg-[#FFEF6D] border-[#c8aa1e] border-1 shadow-[3px_4px_10px_rgba(0,0,0,0.1)] `}>
                ...
                <span> and come to a <span className="text-lg text-[#745307] font-bold">KINTSUGI </span>
                    Hackathon in <span className="text-[#B88900] font-bold">Kyoto</span>!!
                </span>
            </div>
            <div className="relative -rotate-2 hover:scale-[104%] hover:rotate-0 transition-all duration-300 mx-auto max-w-6xl rounded-[55px] border-[4px] shadow-[3px_5px_0_rgba(26,18,9,0.18)] border-[#24221C] bg-[#e8b93f]  p-4">
                ...
                <div className="w-12 h-6 absolute top-38 left-60 -rotate-40">
