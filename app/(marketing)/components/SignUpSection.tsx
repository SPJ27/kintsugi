...
export default function SignUpSection() {
    ...
    return (
        <div className="flex my-12">
            <div className="bg-[#2A1A08] relative items-center flex justify-between  py-6  gap-12  border-4 border-dashed border-[#c9a030] w-full mx-8 px-6 rounded-4xl group-hover:scale-102 transition-all duration-300">
                <div className="flex flex-col gap-4 w-1/2">
                    ...
                    }} className={`${kalam.className} cursor-pointer w-full bg-[#F5E4B0] py-4 text-2xl rounded-xl `}>Sign up
                    </button>
                   )}
