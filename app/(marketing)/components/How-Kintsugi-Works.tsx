...
export default function HowKintsugiWorks() {
    ...
    return (
        <div className="flex flex-col gap-4 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 place-items-center xl:grid-cols-4 gap-4 mt-10 sm:mt-20 justify-center items-center">
                {Cards.map((card) => (
                    <div key={card.id} className="w-full max-w-80 col-span-1 cursor-grab px-6 items-center justify-between py-8 sm:py-12 border-4 border-dashed rounded-3xl h-auto min-h-100 sm:h-120 bg-[#2a1a08] border-[#c9a030] transition-all duration-300  hover:shadow-[8px_10px_0_rgba(26,18,9,0.18)] hover:-rotate-2 hover:-translate-y-2">
