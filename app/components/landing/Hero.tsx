...
export default function Hero() {
    ...
    return (
        <div className="flex  flex-col gap-4  relative min-h-screen justify-center items-center text-center ">
            ...
            <div className="relative -translate-y-12 -rotate-2 hover:scale-[104%] hover:rotate-0 transition-all duration-300 mx-auto w-[calc(100%-1rem)] max-w-4xl rounded-[55px] border-[4px] shadow-[3px_5px_0_rgba(26,18,9,0.18)] border-[#24221C] bg-[#e8b93f] p-4">
                <div className="absolute left-80 hidden sm:block -rotate-2 pointer-events-none -top-6 z-2 border-1 w-30 h-8 border-[#d2b432] bg-[#FFF4968A]" />

                <div className="relative h-[380px] overflow-hidden w-full rounded-[45px] border-[3px] bg-[#fff9e8] border-[#24221C] ">
                    <div className=" absolute left-10 hidden sm:block top-16 h-32 w-56 rounded-md rotate-[-8deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]">
                        <div className="absolute select-none hidden sm:block  left-10 top-8 h-12 w-20 rotate-[-12deg]  rounded-full">
                            <Image src={'/images/doodle.svg'} fill alt={"doodle"} />
                        </div>
                    </div>
                    <div className=" absolute left-28 hidden sm:block  top-8 h-28 w-48 rounded-md rotate-[4deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]" />
                    <div className=" absolute left-74 hidden sm:block  top-10 h-32 w-48 rounded-md rotate-[12deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]">
                        <div className="absolute hidden sm:block select-none left-10 top-16 h-12 w-12 rotate-[10deg] rounded-full">
                            <Image src={'/images/doodle.svg'} fill alt={"doodle"} />

                        </div>
                    </div>
                    <div className="absolute hidden sm:block  right-52 top-8 h-32 w-48 rounded-md rotate-[4deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]" />
                    <div className=" absolute hidden sm:block right-18 top-14 h-28 w-44 rounded-md rotate-[4deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]">
                        <div className="absolute select-none hidden sm:block left-10 top-16 h-12 w-16 rotate-[-12deg] rounded-full">
                            <Image src={'/images/doodle.svg'} fill alt={"doodle"} />
                        </div>
                    </div>

                    <div className=" absolute  left-22 hidden sm:block bottom-18 h-32 w-48 rounded-md rotate-[14deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]">
                        <div className="absolute hidden sm:block select-none right-10 bottom-16 h-12 w-12 rotate-[10deg] rounded-full">
                            <Image src={'/images/doodle.svg'} fill alt={"doodle"} />

                        </div>
                    </div>
                    <div className=" absolute right-22 hidden sm:block bottom-18 h-32 w-50 rounded-md rotate-[-14deg] border-2 border-[#24221c] bg-[#fffdf5] shadow-[2px_3px_0_rgba(0,0,0,0.15)]">
                        <div className="absolute select-none hidden sm:block left-10 bottom-16 h-12 w-12 rotate-[10deg] rounded-full">
                            <Image src={'/images/doodle.svg'} fill alt={"doodle"} />

                        </div>
                    </div>
                    <div className="absolute lg:left-60  top-38 left-10 lg:top-16">
                        <div className="lg:w-60 select-none w-30 h-30 lg:h-60 relative rotate-24" >
            ...
            <div className=" w-[calc(100%-1rem)] max-w-4xl  -translate-y-12 relative items-center text-center flex border-2 py-6 px-6 gap-4 border-dashed bg-[#2a1a08] border-[#c9a030] shadow-[3px_5px_0_rgba(26,18,9,0.18)] rounded-2xl" >
                <div className="absolute hidden md:block left-80 -rotate-2 pointer-events-none -top-4 z-2 border-1 w-30 h-8 border-[#d2b432] bg-[#FFF4968A]" />
                ...
                {session && !isPending && (
                    <Link className={`${kalam.className} w-full text-lg md:text-3xl py-2 font-semibold uppercase rounded-2xl border-4 border-dashed border-[#1a1209] text-center items-center justify-center flex gap-2 text-[#2a1a08] bg-[#e8dfa0] `} href={'/user'}>
                        Open Dashboard
                    </Link>
                )}
                {!session && !isPending && authDisabled && (
                ...
                <div className="w-[1.5px] -bottom-8 left-30 sm:left-100 absolute h-[22px] bg-[#d4a017] -translate-y-2">
