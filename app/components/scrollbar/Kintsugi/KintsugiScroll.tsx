...
export default function KintsugiScrollbar() {
    ...
    return (
        <div className="fixed z-[9999] right-[1px] top-[28px] bottom-[28px] w-[24px] pointer-events-none">
            ...
            <div className="absolute left-1/2 -translate-y-1/2 -translate-x-1/2 w-[28px] h-[52px] will-change-transform duration-150 ease-[cubic-bezier(0.22,1,0.36,1)]" style={{top : `${progress * 100}%`}}>
