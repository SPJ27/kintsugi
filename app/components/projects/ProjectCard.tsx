...
export default function ProjectCard({
  ...
  return (
    <>
      <div
        key={project.id}
        className={`${kalam.className} hover:zoom-101 transition-transform duration-1000 w-full md:w-[740px] lg:w-[940px] h-135 shadow-[3px_5px_0_rgba(26,18,9,0.18)]  flex flex-col  rounded-xl border-[4px] shadow-[3px_5px_0_rgba(26,18,9,0.18)] border-[#24221C] bg-[#e8b93f] p-4`}
      >
        <div className="h-full overflow-y-auto w-full md:w-[700px] lg:w-[900px] scrollbar-none px-6 py-6 rounded-xl border-[3px] gap-2 bg-[#fff9e8] border-[#24221C] flex flex-col">
          <div className="flex justify-center items-center">
            <div className="relative w-[200px] sm:w-[300px] md:w-[500px] h-64 shrink-0 overflow-hidden rounded-xl border-4">
              {project.bannerUrl ? (
                ...
                <div className="bg-[#fdf0c2] w-full h-full flex justify-center items-center text-center text-xl ">
                  No Banner
                </div>
              )}
            </div>
          ...
          <div className="relative h-10 mb-2">
            <h1
              className={`absolute left-[7px]  top-[4px] text-center text-2xl select-none md:text-4xl leading-none tracking-[2px] text-[#1a1209] ${rubiks_Wet_Paint.className}`}
            >
              {project.name}
            </h1>
            <h1
              className={`absolute select-none text-center md:text-4xl text-2xl translate-x-2 leading-none tracking-[2px] text-[#f0c14d] ${rubiks_Wet_Paint.className}  [-webkit-text-stroke:0.7px_#1a1209]`}
            >
              {project.name}
            </h1>
          </div>
            ...
            <div className="flex w-max gap-2 items-center">
              <div>
                {(() => {
                  ...
                  return (
                    <div className="whitespace-nowrap shrink-0 py-1 mx-2 bg-[#2A1A08] text-xl px-4 h-12 items-center text-center justify-center flex  rounded-2xl border-2 text-[#f0c14d] border-[#f0c14d]">
                      {hours}h {minutes}m
                    </div>
                  );
                })()}
              ...
              <div>
                {project.projectDemo && (
                  <a
                    ...
                    className="shrink-0 py-1 mx-2 bg-[#2A1A08] text-xl px-4 h-12 items-center text-center justify-center flex  rounded-2xl border-2 text-[#f0c14d] border-[#f0c14d]"
                  >
                    Demo
                  </a>
                )}
              ...
              <div>
                {shipStatus === "pending" || shipStatus == "perm_rejected" ? (
                  <HideEditButton />
                ) : (
                  <Link
              ...
              {ShipStatusLabel && (
                <div
                  className={`shrink-0 py-1 mx-2 text-md font-bold px-4 h-12 items-center text-center justify-center flex  rounded-2xl border-2 ${ShipStatusLabel.className}`}
                >
