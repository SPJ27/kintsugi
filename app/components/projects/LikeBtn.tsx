...
const LikeBtn = ({
  ...
  return (
    <button
      ...
      className="mx-2 flex h-12 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg cursor-pointer border-2 border-[#f0c14d] bg-[#2A1A08] px-4 py-1 text-xl text-[#f0c14d]"
    >
      <Heart
